...
This is a DeepSurv loss based net for RFS prediction of OPC cancer, input can be only image (CT/PET) and/or GTV(autoseg), clinical data and hpv
...
def main():
    ...
    opt.usehpv =True # add hpv to clinical
