...
This is a DeepSurv loss based net for RFS prediction of OPC cancer, input can be only image (CT/PET) and/or GTV(autoseg), clinical data and radiomics (features and linear predictor)
...
from utlis import make_surv_array , get_breaks , surv_likelihood,  get_surv_time, get_data_dict_trainusingHungSeg, get_model, plot_images, get_clc_model
import torch.nn as nn
from para_opts import parse_opts
from torch.optim.lr_scheduler import MultiStepLR
import wandb
from test import test_epoch, test_epoch_tumor, test_epoch_tumor_new
import losses
